...
<p>JoBoardGame ("us", "we", or "our") operates the www.joboardgame.tk website and the JoBoardGame mobile application (hereinafter referred to as the "Service").</p>

<p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. Our Privacy Policy  for JoBoardGame is created with the help of the <a href="https://www.privacypolicies.com/free-privacy-policy-generator/">PrivacyPolicies.com Privacy Policy Generator</a>.</p>
...
<p>JoBoardGame uses the collected data for various purposes:</p>    
<ul>
...
<p>JoBoardGame may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
<ul>
    <li>To comply with a legal obligation</li>
    <li>To protect and defend the rights or property of JoBoardGame</li>
...
<ul>
            <li>By visiting this page on our website: www.joboardgame.tk</li>
      
        </ul>
  </div>
</templ<h1>Privacy Policy</h1>
